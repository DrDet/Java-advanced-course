cd java
javac -d .\.. -cp .\..\artifacts\JarImplementorTest.jar -Xlint .\ru\ifmo\rain\vaksman\implementor\Implementor.java .\ru\ifmo\rain\vaksman\implementor\CodeGenerator.java
cd ..
